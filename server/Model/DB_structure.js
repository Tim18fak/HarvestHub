...
const ActiveAdmin = mongoose.model('activeAdmin',activeAdmin)
...
module.exports = { Farmer, Product, User, Transaction, Review, BlockedUser, Admin,ChatModule,Bookmark,ActiveConsumer,ActiveFarmer,ActiveAdmin };
